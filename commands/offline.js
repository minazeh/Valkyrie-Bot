...
module.exports = {
    ...
    async run (bot,message,args) {
        ...
        if( args.length == 0 ){
            ...
            const guildMember = await warAttendance.findAll({ where: { logKey: args, activityStatus: 'Offline'} });
            ...
            if(guildMember.length != 0){
                ...
                onlineMemberRecord.setTitle('Paradox • War Attendance Record');
                onlineMemberRecord.addField('Guild War • ' + warDate + '\n\nOffline Member List', onlineMembers);
